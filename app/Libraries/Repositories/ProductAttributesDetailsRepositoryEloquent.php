...
class ProductAttributesDetailsRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return ProductAttributesDetails::class;
    }
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['search'])) {
            $value = $this->customSearch($value, $input, ['product_id', 'value', 'values']);
        }
