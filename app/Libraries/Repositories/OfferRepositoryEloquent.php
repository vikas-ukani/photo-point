...
class OfferRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['search'])) {
            $value = $this->customSearch($value, $input, ['name', 'code', 'discount']);
        }
        ...
        if (isset($input['discount'])) {
            $value = $value->where('discount', $input['discount']);
        }
        ...
        if (isset($input['valid_from'])) {
            $value = $value->where('valid_from', ">=", $input['valid_from']);
        }
        if (isset($input['valid_to'])) {
            $value = $value->where('valid_to', "<=", $input['valid_to']);
        }
