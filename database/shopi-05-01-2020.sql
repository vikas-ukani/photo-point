...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2020 at 03:06 PM
...
CREATE TABLE `products` (
  ...
  `size` text COLLATE utf8mb4_unicode_ci COMMENT 'Multiple Sizes.',
  `color` text COLLATE utf8mb4_unicode_ci COMMENT 'color',
