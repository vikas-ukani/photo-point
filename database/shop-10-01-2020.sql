...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2020 at 05:01 PM
...
-- Error reading data for table shopikana.orders: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `shopikana`.`orders`' at line 1
